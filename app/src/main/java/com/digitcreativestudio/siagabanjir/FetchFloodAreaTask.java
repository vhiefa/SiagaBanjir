...
import com.digitcreativestudio.siagabanjir.data1.FloodContract;
...
public class FetchFloodAreaTask extends AsyncTask<Void, Void, Void> {
    ...
    public void deleteAllRecords() {
        mContext.getContentResolver().delete(
                FloodContract.FloodAreaEntry.CONTENT_URI,
                null,
                null
        );
    ...
    private void getNewsDataFromJson(String feedJsonStr, int numList)
        ...
        JSONArray jsonArray_result = jsonObject.getJSONArray("");
        ...
        if (cVVector.size() > 0) {
            ...
            mContext.getContentResolver().bulkInsert(FloodContract.FloodAreaEntry.CONTENT_URI, cvArray);
            deleteAllRecords();
            Log.v(LOG_TAG, "All databases was deleted");
            int rowsInserted = mContext.getContentResolver()
                    .bulkInsert(FloodContract.FloodAreaEntry.CONTENT_URI, cvArray);
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            getNewsDataFromJson(feedJsonStr, numList);
        }
